...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    public void start(final boolean startFactory) throws MQClientException {
        switch (this.serviceState) {
            case CREATE_JUST:
                ...
                // 客户端实例，整个JVM实例中只存在一个MQClientManager实例，维护一个MQClientInstance缓存表，也就是同一个clientId只会创建一个MQClientInstance
                // 如果jvm中既有生产者，又有消费者，则会共用一个MQClientInstance
    ...
    private SendResult sendDefaultImpl(
        ...
        // 获取topic的路由信息，只有获取了这些信息我们才知道消息要发送到的具体Broker节点
